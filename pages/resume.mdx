...
##### BACKGROUND
I've been learning programming since 2014 when I started building websites for fun. I then started working as a freelancer in 2016 and got excellent feedback from clients around the globe. I initially started with WordPress but then moved to NodeJS and Typescript. I love working in/with startups because I think it's the fastest way to have an impact. For the last few years, I'm trying to disrupt the healthcare sector with the skills and knowledge I possess.
##### OBJECTIVE
“I'm more inclined towards the engineering & architectural part of software applications and I love problem-solving. I want to take the path of a Software Architect.”
...
<small>
- Worked on Vue.JS and implemented a centralized Vuex store in the web app (app.rocketbots.io)
